...
These are, **in this order**: *ddlat*, *ddlong* and *tax*  
...
## Running a full `ConR` with protected areas
...
```{r message=FALSE}
MyResults <- IUCN.eval(df_mada_conR, protec.areas = mada_shape, ID_shape_PA = "WDPA_PID", showWarnings = FALSE)
```
...
This will create four spatial maps, saved in your working directory *IUCN_results_map*  

We can zoom into the country area we want using the coordinates limits  

...
This database now contains **`r length(df_mada_conR$RecordedBy)`** unique records representing **`r length(unique(df_mada_conR$genus))`** genera and **`r length(unique(df_mada_conR$specific_epithet))`** species of Annonaceae in Madagascar.
...
The shapefile must be in your directory already  
